    ...
    <div className="space-y-0">
      ...
      <section className="py-12 bg-white border-b border-slate-200">
        <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-6">
          {/* Card 1: Men's Ethnic */}
          <ScrollReveal direction="up" delay={0}>
            <div className="group relative h-64 rounded-2xl overflow-hidden shadow-md hover:shadow-xl transition-all duration-500 border border-slate-200">
              <img
      ...
      <section className="py-16 bg-slate-50 text-slate-900 relative overflow-hidden border-t border-b border-slate-200">
        <div className="max-w-7xl mx-auto px-4 text-center space-y-8 relative z-10">
          <ScrollReveal direction="up" delay={0}>
            <div className="max-w-xl mx-auto space-y-2">
              <h2 className="text-2xl md:text-4xl font-black uppercase tracking-tight text-slate-950">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 pt-4 text-left">
            <ScrollReveal direction="up" delay={100}>
              <div className="p-6 rounded-2xl bg-white border border-slate-200 space-y-4 hover:border-amber-400 hover:scale-102 transition-all duration-300 shadow-sm hover:shadow-xl group">
                ...
                <h4 className="text-base font-extrabold uppercase tracking-tight text-slate-900">Fast Express Shipping</h4>
            ...
            <ScrollReveal direction="up" delay={200}>
              <div className="p-6 rounded-2xl bg-white border border-slate-200 space-y-4 hover:border-emerald-500 hover:scale-102 transition-all duration-300 shadow-sm hover:shadow-xl group">
                ...
                <h4 className="text-base font-extrabold uppercase tracking-tight text-slate-900">Cash on Delivery</h4>
                <p className="text-xs text-slate-600 leading-relaxed font-medium">
            ...
            <ScrollReveal direction="up" delay={300}>
              <div className="p-6 rounded-2xl bg-white border border-slate-200 space-y-4 hover:border-pink-500 hover:scale-102 transition-all duration-300 shadow-sm hover:shadow-xl group">
                ...
                <h4 className="text-base font-extrabold uppercase tracking-tight text-slate-900">Hassle-Free Exchange</h4>
                <p className="text-xs text-slate-600 leading-relaxed font-medium">
            ...
            <ScrollReveal direction="up" delay={400}>
              <div className="p-6 rounded-2xl bg-white border border-slate-200 space-y-4 hover:border-amber-400 hover:scale-102 transition-all duration-300 shadow-sm hover:shadow-xl group">
                ...
                <h4 className="text-base font-extrabold uppercase tracking-tight text-slate-900">100% Genuine Quality</h4>
                <p className="text-xs text-slate-600 leading-relaxed font-medium">
