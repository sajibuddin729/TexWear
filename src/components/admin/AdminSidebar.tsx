...
import { LayoutDashboard, Package, FolderTree, ShoppingBag, Settings, ArrowLeft, Shield, LogOut, MessageSquareHeart, Mail } from 'lucide-react';
...
export const AdminSidebar: React.FC = () => {
  ...
  const links = [
    ...
    { href: '/admintexwear/messages', label: 'Contact Messages', icon: Mail },
